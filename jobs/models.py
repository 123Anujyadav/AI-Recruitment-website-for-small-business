...
class CandidateProfile(models.Model):
    ...
    resume_file = models.FileField(upload_to='resumes/', null=True, blank=True, help_text="Uploaded resume PDF")
    resume_text = models.TextField(blank=True, default='', help_text="Extracted completely raw text from resume")
    resume_parsed_skills = models.TextField(blank=True, default='', help_text="Skills extracted by AI")
    resume_experience = models.IntegerField(null=True, blank=True, help_text="Experience extracted by AI")
    resume_ats_score = models.FloatField(null=True, blank=True, help_text="ATS standard score (0-100) generated by AI")
    resume_summary = models.TextField(blank=True, default='', help_text="General resume strength summary by AI")
